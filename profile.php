...
<body>
    ...
    <!-- Header Start -->
    <div class="bg-success" style="background: url('img/gedung_SMA SENOPATI.jpg') no-repeat center center/cover; position: relative;">
        ...
        <div class="container py-5" style="position: relative; z-index: 1;">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">PROFILE SMA SENOPATI</h1>
    ...
    <!-- Header End -->
     ...
     <div class="container-xxl py-5">
         <div class="container">
             <div class="row g-4">
                 <?php if ($result->num_rows > 0): // Periksa jika ada data ?>
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="img/LOGO_SMA-0000.jpg" alt="" style="object-fit: contain;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                <h6 class="section-title bg-white text-start text-primary pe-3">SMA SENOPATI SIDOARJO</h6>
                <h1 class="mb-4">Visi</h1>
                <p class="mb-4">Mewujudkan generasi yang Bertakwa, Berakhlak Mulia, Cendekia, Nasionalis, dan Kompetitif.</p>
 ...
 <div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="img/guruguru.jpg" alt="" style="object-fit: contain;">
                </div>
            </div>
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                <h6 class="section-title bg-white text-start text-primary pe-3 ">SMA SENOPATI SIDOARJO </h6>
                <h1 class="mb-4">Misi</h1>
                <p class="mb-4">1. Menyediakan pendidikan berkualitas yang mendukung pengembangan potensi siswa di bidang akademik, seni, dan olahraga.</p>
                <p class="mb-4">2. Mengembangkan karakter siswa yang berlandaskan nilai-nilai moral, kejujuran, dan tanggung jawab.</p>
                <p class="mb-4">3. Menanamkan semangat cinta tanah air dan kepedulian terhadap lingkungan sekitar.</p>
                <p class="mb-4">4. Mendorong penguasaan teknologi informasi agar siswa mampu bersaing di era digital.</p>
                <p class="mb-4">5. Menjalin kerjasama dengan berbagai pihak untuk memberikan peluang lebih luas dalam pengembangan diri siswa.</p>
